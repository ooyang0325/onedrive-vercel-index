...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'diego930325@ooyang.gq',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/🥟 Some test files/Protected route',
                    '/academic-portfolio-private-backup', '/Desktop', '/Documents', '/NTU', '/Photo', '/Photo/!!!preset!!!', '/Pictures', '/畢業的照片', '/高中報告', '/漫畫', '/boring', '/GoodNotes', '/waifu'
                   ],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/ooyang0325',
    },
    {
      name: 'Instagram',
      link: 'https://www.instagram.com/oo___yang/',
    }
  ],
